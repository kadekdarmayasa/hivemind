  ...
  return portfolio.orientation === 'potrait' ? (
    <Fade bottom delay={index * 300}>
      <div key={portfolio._id} className='rounded-lg relative col-span-4  row-span-4 overflow-hidden group'>
        <Image width={400} height={600} src={portfolio.imageId} alt={portfolio.projectName} className='h-full w-full object-cover group-hover:scale-105 transition-all' />
    ...
    <Fade bottom delay={index * 300}>
      <div key={portfolio._id} className='rounded-lg col-span-4 relative row-span-2 overflow-hidden group'>
        <Image width={400} height={200} src={portfolio.imageId} alt={portfolio.projectName} className='h-full w-full object-cover group-hover:scale-105 transition-all' />
