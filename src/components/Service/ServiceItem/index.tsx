...
export default function ServiceItem({ service }: { service: ServiceProps }): JSX.Element {
  return (
    <div className={`
      bg-white shadow-black-sm hover:shadow-black-md hover:scale-[1.02] transition-all w-[350px] 
      ...
      >
        ...
        <div className={
          `absolute h-[2px] rounded-lg w-0 left-0 group-hover:w-full -bottom-1 opacity-0 
