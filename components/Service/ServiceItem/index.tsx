...
export default function ServiceItem({ service }: { service: ServiceProps }): JSX.Element {
  return (
    <div key={service._id} className='bg-white shadow-black-sm hover:shadow-black-md hover:scale-[1.02] transition-all w-[350px] h-[500px] px-10 py-14 flex flex-col items-start rounded-xl'>
